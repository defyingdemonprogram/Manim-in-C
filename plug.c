...
static Instruction instructions[] = {
    {.move_to = 0, .write_to = "Manim"},
    {.move_to = 1, .write_to = "in"},
    {.move_to = 2, .write_to = "C"},
    {.move_to = 3, .write_to = "is"},
    {.move_to = 4, .write_to = "Panim"},
    {.move_to = 5, .write_to = "@real"},
    {.move_to = 6, .write_to = ":)"},
};
